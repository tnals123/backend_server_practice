...
aws.config.update(process.env.AMAJON_KEY);
const s3 = new aws.S3();
...
router.get("/post",(req,res) => {
    ...
    try{
        ...
        tokenVerify.verifyToken(userData.id,token,(data) => {
            if (data){
                console.log("맞음!")
...
router.post("/post/specific",(req,res) => {
    ...
    const sql = "SELECT * FROM backend.userpost WHERE postcontents = $1"
            
    client.query(sql,[search],(err,data) => {
